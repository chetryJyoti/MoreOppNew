    ...
    <div className="mx-35 p-7">
      ...
      <div className="mt-3">
        ...
        <div className="grid grid-cols-4 gap-1 ">
          <div className=" border-2 border-blue-200 hover:bg-blue-400 text-black hover:text-white px-4 py-2 rounded cursor-pointer">
            <Link
              to="/hackathons"
        ...
        <div>
          <div className="my-5">
            <h3 className="text-xl">Latest and upcomming HACKATHONS</h3>
          </div>
